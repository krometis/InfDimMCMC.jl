#Methods for Hamiltonian MCMC (HMC) method
# Beskos, Girolami, et al, 2017, Algorithm 2.3
#
function stepHmc(cur::mcmcSample, m::mcmcProb, hmc_e::Float64, hmc_tau::Float64; verbose=2, ve=(rand(m.prior)-mean(m.prior)))
